...
RULES = [''' The following are instructions for the format and rules to follow:
 ...
 6. Do not repeat the same ANSWER twice among different ANSWER/CLUE pairs.''']
...
class Gemini:
    ...
    def generate_words_clues(self, topic, numclues, difficulty):
        prompt = PROMPT[0] + difficulty + PROMPT[1] + topic + PROMPT[2] + RULES[0] + numclues + RULES[1] + EXAMPLES
        print(prompt)
